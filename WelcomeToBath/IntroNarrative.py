...
def Tell_us_a_story():
    ...
    says("evolutionary trajectory unlike that of any hominid yet discovered. In fact, one might say that the ")
    ...
    time.sleep(m)
    says(" There were also no elderly and no infirm, and well, no one that stuck out. ",)
    ...
    says("village of anonymous pacifists who go about their days playing lotteries and shirking their responsibilties.")
    time.sleep(m)
